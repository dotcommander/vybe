...
func NewEventsCmd() *cobra.Command {
	...
	cmd.AddCommand(newEventsAddCmd())
...
// newEventsAddCmd creates the "events add" subcommand (formerly top-level "log").
func newEventsAddCmd() *cobra.Command {
	var (
		kind     string
		message  string
		taskID   string
	...
	cmd := &cobra.Command{
		Use:   "add",
		Short: "Add an event to the continuity log",
		Long:  "Create an event entry in the continuity system",
