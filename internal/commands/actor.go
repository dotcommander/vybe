...
// 4) env var VIBE_AGENT
//
// Deprecation plan: --actor is kept for backward compatibility through v0.x.
// It will be removed in v1.0. Callers should migrate to --agent or VIBE_AGENT.
